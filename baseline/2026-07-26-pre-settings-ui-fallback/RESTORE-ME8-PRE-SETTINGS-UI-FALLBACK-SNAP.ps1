# Restore ME8 to pre-Settings-UI-fallback backup
...
Write-Host 'RESTORE ME8 pre-Settings-UI-fallback backup'
...
foreach ($entry in $manifest.files) {
    ...
    # SNAP scripts restore into baseline folder only when path has no slash — skip writing SNAP into AppRoot root as weird; allow restore of wrappers to AppRoot
...
Write-Host 'See BASELINE-ME8-PRE-SETTINGS-UI-FALLBACK.md'
