# Verify live ME8 matches me8-v1 baseline (SHA256).
...
Write-Host 'VERIFY me8-v1 baseline'
...
if ($missingLive -eq 0 -and $missingBase -eq 0 -and $mismatch -eq 0) {
    Write-Host 'VERIFY OK - live ME8 matches me8-v1 lock byte-for-byte.' -ForegroundColor Green
    exit 0
}
