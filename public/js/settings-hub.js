...
(function (global) {
    ...
    /* fmtDate / fmtDateTime owned by axiom-datetime.js (Centre unify). */
    var fmtDate = typeof global.fmtDate === 'function'
        ? global.fmtDate
        : function (iso) { return iso ? String(iso).slice(0, 10) : '\u2014'; };
    var fmtDateTime = typeof global.fmtDateTime === 'function'
        ? global.fmtDateTime
        : function (iso) { return iso ? String(iso).slice(0, 16).replace('T', ' ') : '\u2014'; };
