...
/* AIRGAP-OUTBOUND-LINKS-V1 — every IdP call is bounded; a dead IdP fails the login cleanly. */
const OIDC_FETCH_TIMEOUT_MS = 10000;

async function fetchJson(url) {
    const res = await fetch(url, { headers: { Accept: 'application/json' }, signal: AbortSignal.timeout(OIDC_FETCH_TIMEOUT_MS) });
