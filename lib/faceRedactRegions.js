 ...
 * one-per-sample flood).
 * REDACT-PREVIEW-CONTROLS-BURN-V1: deleting a preview box sends it as an
 * exclude seed on face-follow Save (burn skips matching detections).
 *
