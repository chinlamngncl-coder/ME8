/**
 * Enterprise env profile (Valkey + Postgres).
 * Valkey runtime: wired when FM_REDIS_URL is set (VALKEY-FLEET-RUNTIME-STATE-DEGRADE-V1).
 * Catalog: FM_CATALOG_* via siteDb (separate MOB).
 */
