    ...
    initPromise = (async () => {
        ...
        try {
            ...
            try {
                ...
                if (!check.rows[0] || Number(check.rows[0].schema_version) < 13) {
                    throw new Error('PostgreSQL catalog schema migration did not complete (need version >= 13 case_files_geospatial_json)');
                }
            } finally {
                client.release();
            }
...
module.exports = {
    ...
    getEvidenceFile, listEvidenceFiles, listEvidenceFilesPage, listActiveEvidenceUploadedBefore, insertEvidenceDownload,
