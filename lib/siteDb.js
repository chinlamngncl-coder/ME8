    ...
    initPromise = (async () => {
        ...
        try {
            ...
            try {
                ...
                if (!check.rows[0] || Number(check.rows[0].schema_version) < 18) {
                    throw new Error('PostgreSQL catalog schema migration did not complete (need version >= 18 vms_storage_volumes)');
                }
            } finally {
                client.release();
            }
