    ...
    initPromise = (async () => {
        ...
        try {
            ...
            try {
                ...
                if (!check.rows[0] || Number(check.rows[0].schema_version) < 10) {
                    throw new Error('PostgreSQL catalog schema migration did not complete (need version >= 10 bwc_serial_no)');
                }
            } finally {
                client.release();
            }
